...
;; Actions ;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(:durative-action navigation_air_MultiRotor
...
(:durative-action navigation_water_MultiRotor
	:parameters (?r - robot ?poi1 ?poi2 - pointofinterest ?s - site)
...
(:durative-action takeoff_MultiRotor
...
(:durative-action landing_MultiRotor
	:parameters (?r - robot ?poi - pointofinterest)
...
(:durative-action survey_site_2r
