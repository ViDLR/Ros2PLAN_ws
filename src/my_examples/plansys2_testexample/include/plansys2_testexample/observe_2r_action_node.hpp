#ifndef OBSERVE_2R_ACTION_NODE_HPP_
#define OBSERVE_2R_ACTION_NODE_HPP_
...
class Observe2rActionNode : public plansys2::ActionExecutorClient
{
public:
  Observe2rActionNode(const std::string &robot_name, const std::string &team_name);
