#ifndef SWITCH_WATERAIR_ACTION_NODE_HPP_
#define SWITCH_WATERAIR_ACTION_NODE_HPP_
...
class SwitchWaterAirActionNode : public plansys2::ActionExecutorClient
{
public:
  SwitchWaterAirActionNode(const std::string &robot_name, const std::string &team_name);
...
#endif  // SWITCH_WATERAIR_ACTION_NODE_
