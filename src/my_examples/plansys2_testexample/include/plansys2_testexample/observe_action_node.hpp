#ifndef OBSERVE_ACTION_NODE_HPP_
#define OBSERVE_ACTION_NODE_HPP_
...
class ObserveActionNode : public plansys2::ActionExecutorClient
{
public:
  ObserveActionNode(const std::string &robot_name, const std::string &team_name);
