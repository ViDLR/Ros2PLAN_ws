#ifndef SWITCH_AIRWATER_ACTION_NODE_HPP_
#define SWITCH_AIRWATER_ACTION_NODE_HPP_
...
class SwitchAirWaterActionNode : public plansys2::ActionExecutorClient
{
public:
  SwitchAirWaterActionNode(const std::string &robot_name, const std::string &team_name);
...
#endif  // SWITCH_AIRWATER_ACTION_NODE_
