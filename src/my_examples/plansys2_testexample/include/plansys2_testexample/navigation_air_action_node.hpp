#ifndef NAVIGATION_AIR_ACTION_NODE_HPP_
#define NAVIGATION_AIR_ACTION_NODE_HPP_
...
class NavigationAirActionNode : public plansys2::ActionExecutorClient
{
public:
  NavigationAirActionNode(const std::string &robot_name, const std::string &team_name);
...
#endif  // NAVIGATION_AIR_ACTION_NODE_
